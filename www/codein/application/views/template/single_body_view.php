		...
		<section class="page-banner-section">
			<div class="container">
				...
				<div class="row">
                    ...
                    <li><a href="<?php echo base_url();?>">главная</a></li> / <li><a href="<?php echo base_url();?>news/">новости</a></li> / <li><a href="<?php echo base_url();?><?php echo base_url();?>news/<?php echo $page->post_url;?>" class="active"><?php echo $page->post_name;?></a></li>
                    </ul></div>
					<div class="col-md-6">
						<h2><?php echo $page->post_name;?></h2>
					</div>
					<div class="col-md-6">
						<ul class="page-depth">
